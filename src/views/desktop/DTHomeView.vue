...
.dt-home__resume {
  ...
  box-shadow: 0 10px 28px rgba(34,211,238,0.21), 0 1px 0 rgba(255,255,255,0.35) inset, 0 -1px 0 rgba(0,0,0,0.18) inset;
...
.dt-home__cont-play {
  ...
  box-shadow: 0 14px 36px rgba(34,211,238,0.23), 0 1px 0 rgba(255,255,255,0.4) inset, 0 -1px 0 rgba(0,0,0,0.18) inset;
}
